from tkinter import *
from test_connection_db import read_card_uid
...
#
# # ==================== Buttons ==================================
read_BTN = Button(holder_frame, text='read', font=('Helvetica', 13),
                  command=lambda: read_user())
read_BTN.place(relx=0.35, relwidth=0.3, rely=0.5)
